    ...
    msg1: [
      {
        ...
        text:
          "SpartaHack is a student-run 48 hour coding marathon that encourages you to build a project from scratch and learn something new! Also you can earn a ton of prizes if you're interested in that type of thing. 😏"
      },
      {
        title: "Who can join?",
        text:
      ...
      },
      {
        title: "When is it?",
        text:
          "SpartaHack normally takes place in mid to late January each year! Keep an eye out on it if you go there"
      }
    ]
  })
};
